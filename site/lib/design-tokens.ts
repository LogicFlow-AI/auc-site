...
export const navigation = {
  ...
  footer: {
    ...
    conferences: [
      ...
      { label: 'South Queensland', href: '/church-near-me/churches-in-south-queensland/' },
      { label: 'North New South Wales', href: '/church-near-me/churches-in-north-nsw/' },
    ...
    resources: [
      { label: 'Adventurers', href: '/uncategorized/adventurers/' },
      { label: 'Pathfinders', href: '/ministries/youth/' },
      { label: 'Adventist Schools', href: '/education/' },
      { label: 'Avondale University', href: '/education/' },
      { label: 'Mamarapha', href: '/ministries/atsim/' },
      { label: 'Catalyst', href: '/ministries/personal_ministries/' },
      { label: 'Sydney Adventist Hospital', href: '/health-and-wellbeing/' },
      { label: 'Adventist Aged Care', href: '/health-and-wellbeing/' },
      { label: 'Adventist Heritage', href: '/uncategorized/adventist-heritage/' },
    ],
    media: [
      { label: 'Faith FM', href: '/uncategorized/faith-fm/' },
      { label: 'Hope Channel', href: '/uncategorized/hope-channel/' },
      { label: 'Bible Study Online', href: '/ministries/bible-study-online/' },
      { label: 'Waymaker TV', href: '/media/' },
      { label: 'Elia Wellness', href: '/health-and-wellbeing/' },
      { label: 'ADRA', href: '/ministries/adra/' },
      { label: 'Disciple.org.au', href: '/ministries/bible-study-online/' },
    ],
  },
};
